...
export const EditRecipe = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    Object.keys(recipe)
      ...
      .forEach((key) => data.append(key, recipe[key]));
      ...
      <Row>
        <Col md={{ span: 6, offset: 3 }}>
          <Card className="card-css">
            <Card.Header className="headings d-flex justify-content-around">
              {recipe && !pageError ? (
                <>
              ...
              {loading ? (
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <Button
                    variant="primary"
                    type="submit"
                    aria-label="Save changed recipe"
                  >
                    Save!
                  </Button>
      ...
      >
        ...
        <Modal.Footer>
          ...
          <Button
            ...
            aria-label="No, do not delete recipe"
          >
            No
          </Button>
        </Modal.Footer>
