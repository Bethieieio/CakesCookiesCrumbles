                    ...
                    <Card.Header className='recipe-header-card'>
                        ...
                        <Container>
                            <Row className='justify-content-center' xs="auto">
                                ...
                                <Col md={{ span: 3 }} className="d-flex justify-content-center headings"> <h3 className='h4'>{recipe.title}</h3> </Col>
                                <Col className="d-flex justify-content-center"><FavouriteToggle id={recipe.id} favouriteId={recipe.favourites[0]?.id} /></Col>
                            </Row>
                            <Row>
                                <Col className="d-flex justify-content-center">
                                {recipe.is_owner && <FontAwesomeIcon className='pencil' aria-label='Edit Recipe' icon={faPencil} onClick={() => {
                        ...
                        <Container>
                            <Row>
                                ...
                                <Col>
                                    ...
                                    {recipe.ingredients.split('\n').map((line)=> <p className='josefin' key={line}>{line}</p>)}
                                </Col>
                            </Row>
                            <Row>
                                <Col>
